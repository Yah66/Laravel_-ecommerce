...
<body id="kt_body"
    ...
    <div class="wrapper" id="app">
        ...
        <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
            <!--begin::Logo-->
            <a href="index.html">
                <img alt="Logo" src="{{ asset('assets/media/logos/stars.png') }}" />
            </a>
            <!--end::Logo-->
            <!--begin::Toolbar-->
                ...
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    ...
                    <div class="brand flex-column-auto" id="kt_brand">
                        ...
                        <a href="#" class="brand-logo">
                            {{-- <img alt="Logo" src="{{ asset('assets/media/logos/ecommerce.png') }}" width="110" height="70" /> --}}
                        </a>
                        <!--end::Logo-->
                        <!--begin::Toggle-->
                                                    ...
                                                    <ul class="menu-subnav">
                                                        ...
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="{{route('admin.languages')}}"
                                                                ...
                                                                <span class="menu-text">Languages
                                                          ...
                                                          <li class="menu-item" aria-haspopup="true">
                                                            <a href="{{route('admin.main-category')}}"
                                                                ...
                                                                <span class="menu-text">Main Categories
                                                                    ({{ App\Models\MainCategory::count() }})</span>
                                                                </a>
                                                        </li>
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="{{route('admin.vendor')}}"
                                                                ...
                                                                <span class="menu-text">Vendors
                                                                    ({{ App\Models\Vendor::count() }})</span>
                                                                </a>
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="javascript:;" class="menu-link">
                                                            ...
                                                            <span class="menu-label">
                                                                <span
                                                                    class="label label-success label-rounded">2</span>
                                                            </span>
                                                        </a>
                                                    </li>
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="javascript:;" class="menu-link">
                                                            ...
                                                            <span class="menu-label">
                                                                <span
                                                                    class="label label-success label-rounded">3</span>
                                                            </span>
                                                        </a>
                                                    </li>
                                                    <li class="menu-item menu-item-submenu" data-menu-toggle="hover"
                            ...
                            <div class="topbar">
                                                    ...
                                                    <div class="navi navi-hover scroll my-4" data-scroll="true"
                                                        ...
                                                        <a href="#" class="navi-item">
                                                            <div class="navi-link">
                                                                ...
                                                                <div class="navi-text">
                                                                    <div class="font-weight-bold">System reboot has
                                                                        been
                                                        ...
                                                        <a href="#" class="navi-item">
                                                            <div class="navi-link">
                                                                <div class="navi-icon mr-2">
                                                                    <i
                                                                        class="flaticon2-notification text-primary"></i>
                                                                </div>
                                                                <div class="navi-text">
                                ...
                                <div class="topbar-item">
                                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                        ...
                                        <span
                                            class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Yahiaddd</span>
                ...
                <div class="d-flex align-items-center mt-5">
                    <div class="symbol symbol-100 mr-5">
                        <div class="symbol-label"
                            style="background-image:url(assets('assets/media/users/300_21.jpg'))">
                        </div>
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo1.png') }}" alt=""
                                class="w-100" />
                        </div>
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo2.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo2/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo3.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo3/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo4.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo4/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo5.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo5/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo6.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo6/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo7.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo7/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo8.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo8/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo9.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo9/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo10.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo10/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo11.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo11/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo12.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo12/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo13.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="../../demo13/dist"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo14.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo15.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo16.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo17.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo18.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo19.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo20.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo21.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo22.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo23.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo24.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo25.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo26.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo27.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo28.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo29.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
                    ...
                    <div class="overlay rounded-lg mb-8 offcanvas-demo">
                        <div class="overlay-wrapper rounded-lg">
                            <img src="{{ asset('assets/media/demos/demo30.png') }}" alt=""
                                class="w-100" />
                        </div>
                        <div class="overlay-layer">
                            <a href="#"
