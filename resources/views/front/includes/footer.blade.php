                        ...
                        <div class="nov-html col-xl-4 col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <p class="logo-footer"><img src="{{ asset('http://images.vinovathemes.com/prestashop_savemart/logo-footer.png') }}" alt="logo" width="167" height="23" /></p>
        ...
        <div class="container">
            ...
            Copyright © 2018 Vinovathemes. All Rights Reserved
                ...
                <div class="payment-image col-md-6 align-items-center justify-content-md-end justify-content-sm-center d-flex flex-center">
                    <img class="img-fluid" src="{{ asset('/savemart/modules/novthemeconfig/images/payment-logo-1.png') }}" alt="payment" title="Payment" />
                </div>
            </div>
        </div>
    </div>
