<div wire:ignore.self id="lang_form" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="min-height: 400px;">
            <div class="modal-header py-5">
                <h5 class="modal-title">Language Form
                    <span class="d-block text-muted font-size-sm">Add Language</span>
                </h5>
            ...
            <div>
                <form wire:submit.prevent="submit" enctype="multipart/form-data">
                    ...
                    <div class="card-footer">
                        <button type="button" wire:click.prevent="store()" class="btn btn-primary mr-2">Create</button>
