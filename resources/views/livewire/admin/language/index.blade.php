    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container ">
            ...
            <div class="alert-text">
                @if ($addLang)
                    @include('livewire.admin.language.createLanguage')
                @endif
                @if ($updateLang)
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::Button-->
                        <a wire:click="addLang()"class="btn btn-primary font-weight-bolder" data-toggle="modal"
                            data-target="#lang_form">
                    ...
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <div class="row py-3">
                            <div class="col-sm-12">
                                ...
                                data-target="#lang_update" class="btn btn-sm btn-clean btn-icon"
                                title="Edit details">
                                <i class="la la-edit"></i> </a>
                            <a wire:click="delete({{ $d->id }})" title="Delete" data-toggle="modal"
                                data-target="#deleteLang" class="btn btn-sm btn-clean btn-icon" title="Delete"> <i
