                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                rowspan="1" colspan="1"
                                                aria-label=" Name: activate to sort column ascending"
                                                style="width: 69px;">{{ __('messages.category') }}
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                rowspan="1" colspan="1"
                                                aria-label=" price: activate to sort column ascending"
                                                style="width: 69px;">{{ __('messages.price') }}
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                rowspan="1" colspan="1"
                                                aria-label=" discount_price: activate to sort column ascending"
                                                style="width: 69px;">{{ __('messages.discount_price') }}
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                rowspan="1" colspan="1"
                                    ...
                                    <tbody>
                                        @foreach ($data as $d)
                                            <tr class="odd">
                                                ...
                                                <td>{{ $d->name }}</td>
                                                <td>{{ json_decode($d->main_category->name)->en }}</td>
                                                <td>{{ $d->price }}</td>
