<div wire:ignore.self id="updateProduct" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="min-height: 400px;">
            <div class="modal-header py-5">
                <h5 class="modal-title">Update Product
                    <span class="d-block text-muted font-size-sm">Update Product</span>
                </h5>
