    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container ">
            ...
            <div class="alert-text">
                @if ($addUser)
                    @include('livewire.admin.user.createUser')
                @endif
                {{-- @if ($updateLang)
                    @include('livewire.admin.language.updateLanuage')
                @endif--}}
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">
                            Users
                            <span class="text-muted pt-2 font-size-sm d-block">All Users</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <!--begin::Button-->
                        <a wire:click="addUser()"class="btn btn-primary font-weight-bolder" data-toggle="modal"
                            data-target="#user_form">
                ...
                <div class="card-body">
                    ...
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row py-3">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div id="kt_datatable_filter" class="dataTables_filter"><label>Search:<input
                        ...
                        <div class="row py-3">
                            <div class="col-sm-12">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                ...
                                                style="width: 47px;">UserName</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                rowspan="1" colspan="1"
                                                aria-label="Ship Date: activate to sort column ascending"
                                                style="width: 47px;">Email</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                rowspan="1" colspan="1"
                                                aria-label="Ship Date: activate to sort column ascending"
                                                style="width: 47px;">Role</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                rowspan="1" colspan="1"
                                                aria-label="Ship Date: activate to sort column ascending"
                                                style="width: 47px;">Country</th>

                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable"
                                                rowspan="1" colspan="1"
                                                aria-label="Status: activate to sort column ascending"
                                                style="width: 58px;">city</th>
                                ...
                                data-target="#user_update" class="btn btn-sm btn-clean btn-icon"
                                title="Edit details">
                                <i class="la la-edit"></i> </a>
                            <a title="Delete" wire:click="$set('userIdToDelete', {{ $d->id }})"
                                data-toggle="modal" data-target="#deleteUser" class="btn btn-sm btn-clean btn-icon"
                                title="Delete">
