                          ...
                          <ul class="menu level1">
                              @foreach ($categories as $category)
                                  <li class="item  parent"><a href="#" title="Laptops &amp; Accessories"><i
                                          ...
                                          </i>{{ $category->name }}</a><span class="show-sub fa-active-sub"></span><span
                                          class="menu-sub-title">Dell. HP,
                                          Macbook, Alienware and etc...</span>
                          ...
                          <div class="d-flex flex-wrap align-items-center product-miniature js-product-miniature item-row first_item"
                              ...
                              <div class="col-12 col-w40 pl-0">
                                  <div class="thumbnail-container">
                                      ...
                                      <!-- The product page -->
                                      <a href="{{ route('user.show-product', ['id' => $product->id]) }}"
                                      ...
                                      <!-- The user.show-product component -->
                                      ...
                                      <div class="product-groups">
                                          ...
                                          <div class="product-group-price">
                                              ...
                                              <div class="product-price-and-shipping">
                                                  ...
                                                  <br>
                                                  <span itemprop="oldprice" class="price">
                                                      <del>{{ $product->price + $product->discount_price }}
                                                          UK£</del> </span>
                                  ...
                                  <div class="product-buttons d-flex justify-content-center" itemprop="offers"
                                      ...
                                      <form action="http://demo.bestprestashoptheme.com/savemart/ar/عربة التسوق"
                                          ...
                                          <a class="add-to-cart" href="#"
                                              data-button-action="add-to-cart"><i class="novicon-cart"></i><span>أضف
                                                  للسلة</span></a>
                                      </form>
