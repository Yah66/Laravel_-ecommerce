<div wire:ignore.self id="Vendor_form" class="modal fade" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content" style="min-height: 400px;">
            <div class="modal-header py-5">
                <h5 class="modal-title{{ config('app.locale') == 'ar' ? ' text-right' : '' }}">
                    {{ __('messages.Vendor') }}
                    <span class="d-block text-muted font-size-sm">{{ __('messages.add_Vendor') }}</span>
                </h5>
                ...
                <form wire:submit.prevent="store" enctype="multipart/form-data">
                    <div class="card-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label
                                class="{{ config('app.locale') == 'ar' ? 'rtl' : 'ltr' }}">{{ __('messages.logo') }}</label>
                            <input wire:model="logo" type="file" class="form-control form-control-solid"
                                placeholder="{{ __('messages.enter_logo') }}" />
                            @error('logo')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input wire:model="address" type="text" class="form-control form-control-solid"
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="text"wire:model="address"  id="pac-input"  >
